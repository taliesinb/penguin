...
class window_lframe : public window_container
{
  ...
  public:
    ...
    window_lframe(const string& s) : text(s)
    { }    
...
class window_main : public window_frame
{
  ...
  public:
    ...
    window_main(const string& t ="", coord_int min_x =100, coord_int min_y =25) 
...
class base_widget : public base_window
{
  private:
    ...
    string description; // Tool-tips, status-bars, etc, will make use of this.

  public:
  
    // Virtual functions to set the data of the widget.
    virtual void set_value(int value) { }       
    virtual void set_text(const string& value) { }      
    ...
    void set_description(const string& s) { description = s; }
...
{ DEFINE_EI(string_input_ei, input_ei)
  ...
  string_input_ei(const string& t) : text(t)
  { }
};
...
class base_button : public base_widget
{
  ...
  public:
    ...
    base_button(const string& t ="", frame_type f =ft_button_out)
...
{          
  ...
  public:
    ...
    window_label(const string& t = "", bool multi =false, frame_type f =ft_shallow_in)
...
class window_image : public base_window
{
  public: // TODO: Add arbitrary alignment
    ...
    window_image(string file, display_method m =centre);
    window_image(BITMAP* bmp, display_method m =centre);
    window_image();
    ~window_image();
        
    void load(BITMAP* bmp, display_method m =centre);
    void load(string file, display_method m =centre);
...
class window_checkbox : public window_label
{
  ...
  public:
    ...
    window_checkbox(const string& t ="", bool s =false)
...
class window_radiobutton : public window_label
{
  ...
  public:
    ...
    window_radiobutton(const string& t ="")
...
class window_textbox : public base_widget
{
  ...
  public:
    ...
    window_textbox(const string& initial = "", bool ml =false, bool ww =true) 
...
class window_listbox : public base_widget
{
  ...
  public:
    ...
    void remove_item(const string& s);
    void remove_item(int n);
    void clear_list();   
        
    int get_value() const { return cur_sel; }
    string get_text() const { return (cur_sel > -1) ? list[cur_sel] : ""; }
...
{ DEFINE_EI(selection_change_ei, string_input_ei)
  ...
  selection_change_ei(const string& s, int i)
