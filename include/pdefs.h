...
#define Assert(a, b)    { if (!(a)) { cerr << "\"" #a "\" failed at " __FILE__ "(" << __LINE__ << "): " << b << endl; abort(); } }
#define AssertExp(a, b) { if (!(a)) { cerr << "\"" #a "\" failed at " __FILE__ "(" << __LINE__ << "): " << b << endl; throw b; } }

#include "pzone.h"

// These macros are shortcut for describing windows, zones, or bitmaps to an ostream
