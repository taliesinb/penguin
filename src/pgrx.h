...
int char_to_line(FONT* font, const std::string& str, const zone& z, int cpos, bool wrap =true);
int first_char_in_line(FONT* font, const std::string& str, const zone& z, int cpos, bool wrap =true);
int line_to_char(FONT* font, const std::string& str, const zone& z, int cpos, bool wrap =true);
int chars_in_line(FONT* font, const std::string& str, const zone& z, int line, bool wrap=true);
int lines_in_multiline(FONT* font, const std::string& str, const zone& z, bool wrap =true);
void find_multiline_coords(FONT* font, const std::string& str, const zone& z, int i, coord_int& cx, coord_int& cy, int line =0, bool wrap =true);
std::string::size_type find_multiline_index(FONT* font, const std::string& str, const zone& z, coord_int cx, coord_int cy, int line =0, bool wrap =true);
std::string::size_type find_line_index(FONT* font, compass_orientation align, const char* str, const zone& z, coord_int cx, coord_int ox=0, coord_int oy =0);
...
class graphics_context
{
  ...
  public:
    ...
    void render_multiline(const std::string& str, const zone& z, int bc, int cpos=-1, int line =0, bool wrap =true) const;
    ...
    int font_width(const std::string& s) const; // Width of the current font for that std::string
